...
class Scraper {
	...
	async start() {
		...
		if (this.advanced) {
			...
			if (this.advanced.usageRights) {
				build.push('sur:' + this.advanced.usageRights);
				// commercial reuse with modification = fmc
				// commercial reuse = fc
				// noncommercial reuse with modification = fm
				// noncommercial reuse = f
			}
